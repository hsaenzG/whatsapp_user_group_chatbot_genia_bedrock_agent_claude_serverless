...
class Lambdas(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self.community_event_info = aws_lambda.Function(
            self, "community_event_info", 
            description ="Get info of events" ,
            handler="lambda_function.lambda_handler",
            code=aws_lambda.Code.from_asset("./lambdas/code/community_event_info"),
            layers= [Lay.common,Lay.bs4_requests],
            architecture=aws_lambda.Architecture.ARM_64,
            **COMMON_LAMBDA_CONF)
        
        self.community_info = aws_lambda.Function(
            self, "community_info", 
            description ="Get info of the AWS User Group" ,
            handler="lambda_function.lambda_handler",
            code=aws_lambda.Code.from_asset("./lambdas/code/community_info"),
            layers= [Lay.common,Lay.bs4_requests],
            architecture=aws_lambda.Architecture.ARM_64,
            **COMMON_LAMBDA_CONF)
