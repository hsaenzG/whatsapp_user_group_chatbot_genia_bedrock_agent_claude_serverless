...
from bedrock_agents import bedrock_agents
...
class PrivateAssistantStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        DISPLAY_PHONE_NUMBER = '15556240048'
        ...
        agentId,agentAliasId = Age.create_agent("AWSCommunityLeaderAgent",  Fn.community_event_info.function_arn)
       ...
       # Crear una política basada en recursos
        resource_policy = iam.PolicyStatement(
            ...
            resources=[Fn.community_event_info.function_arn],
